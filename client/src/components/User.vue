    ...
    <v-form v-model="valid">
      <v-container>
        <v-row>
          ...
          <v-col cols="12" md="6">
            <v-text-field v-model="user.email" :rules="[v => !!v || 'E-mail is required']" label="E-mail"
              required></v-text-field>
          </v-col>
          <v-col cols="12" md="6">
            <v-text-field v-model="user.password" :type="'password'" :rules="[v => !!v || 'Password is required']"
