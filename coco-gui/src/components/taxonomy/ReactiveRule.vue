...
const formatted_content = ref<string>(hljs.highlight(content.value, { language: 'clips' }).value);
watch(content, () => formatted_content.value = hljs.highlight(content.value, { language: 'clips' }).value);
</script>
