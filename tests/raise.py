...
def init_db(url):
    ...
    # Create the rules
    response = requests.post(url + '/reactive_rule', headers={'Authorization': 'Bearer ' + token}, verify=False,
                             json={'name': 'physical_distress_rule',
